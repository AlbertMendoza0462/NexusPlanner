    ...
    public class SolicitudesController : ControllerBase
    {
        ...
        public async Task<ActionResult<bool>> Aceptar(int id)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception($"La '{nameof(entidad.SolicitudId)}' '{entidad.SolicitudId}' no existe ne la base de datos.");
                }
            }
            catch (Exception e)
            {
        ...
        public async Task<ActionResult<bool>> Cancelar(int id)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception($"Sa '{nameof(entidad.SolicitudId)}' '{entidad.SolicitudId}' no existe ne la base de datos.");
                }
            }
            catch (Exception e)
            {
